...
export const THEMES: Theme[] = [
  // Transport
  { id: "t1",  label: "Aeroplane",    emoji: "✈️",  genre: "Transport" },
  { id: "t2",  label: "Airport",      emoji: "🛫",  genre: "Transport" },
  { id: "t10", label: "Boats",        emoji: "⛵",  genre: "Transport" },
  { id: "t11", label: "Bus",          emoji: "🚌",  genre: "Transport" },
  { id: "t14", label: "Car",          emoji: "🚗",  genre: "Transport" },
  { id: "t46", label: "Parking",      emoji: "🅿️", genre: "Transport" },
  { id: "t53", label: "Ship",         emoji: "🚢",  genre: "Transport" },
  // Nature
  { id: "t4",  label: "Animals",      emoji: "🐾",  genre: "Nature" },
  { id: "t22", label: "Farm",         emoji: "🌾",  genre: "Nature" },
  { id: "t24", label: "Flowers",      emoji: "🌸",  genre: "Nature" },
  { id: "t33", label: "Jungle",       emoji: "🌿",  genre: "Nature" },
  { id: "t44", label: "Ocean",        emoji: "🌊",  genre: "Nature" },
  { id: "t51", label: "Sand",         emoji: "🏖️", genre: "Nature" },
  { id: "t60", label: "Water",        emoji: "💦",  genre: "Nature" },
  // Food & Drink
  { id: "t12", label: "Candy",        emoji: "🍬",  genre: "Food & Drink" },
  { id: "t18", label: "Coffee",       emoji: "☕",  genre: "Food & Drink" },
  { id: "t25", label: "Food",         emoji: "🍔",  genre: "Food & Drink" },
  { id: "t26", label: "Fruits",       emoji: "🍎",  genre: "Food & Drink" },
  { id: "t32", label: "Jelly",        emoji: "🍮",  genre: "Food & Drink" },
  { id: "t57", label: "Sushi",        emoji: "🍣",  genre: "Food & Drink" },
  // Fantasy & Sci-Fi
  { id: "t3",  label: "Alien",        emoji: "👽",  genre: "Fantasy & Sci-Fi" },
  { id: "t16", label: "Castle",       emoji: "🏰",  genre: "Fantasy & Sci-Fi" },
  { id: "t34", label: "Kingdom",      emoji: "👑",  genre: "Fantasy & Sci-Fi" },
  { id: "t42", label: "Monsters",     emoji: "👾",  genre: "Fantasy & Sci-Fi" },
  { id: "t48", label: "Planets",      emoji: "🪐",  genre: "Fantasy & Sci-Fi" },
  { id: "t50", label: "Russian Doll", emoji: "🪆",  genre: "Fantasy & Sci-Fi" },
  { id: "t56", label: "Space",        emoji: "🚀",  genre: "Fantasy & Sci-Fi" },
  // Action
  { id: "t5",  label: "Archery",      emoji: "🏹",  genre: "Action" },
  { id: "t6",  label: "Arrows",       emoji: "➡️",  genre: "Action" },
  { id: "t8",  label: "Balls",        emoji: "⚽",  genre: "Action" },
  { id: "t13", label: "Cannon",       emoji: "💣",  genre: "Action" },
  { id: "t29", label: "Gun",          emoji: "🔫",  genre: "Action" },
  // Lifestyle
  { id: "t17", label: "City",         emoji: "🏙️", genre: "Lifestyle" },
  { id: "t20", label: "Crowd",        emoji: "👥",  genre: "Lifestyle" },
  { id: "t23", label: "Fashion",      emoji: "👗",  genre: "Lifestyle" },
  { id: "t38", label: "Makeover",     emoji: "💄",  genre: "Lifestyle" },
  { id: "t45", label: "Office",       emoji: "🏢",  genre: "Lifestyle" },
  { id: "t47", label: "People",       emoji: "🧑",  genre: "Lifestyle" },
  // Objects
  { id: "t7",  label: "ASMR Cutting", emoji: "✂️",  genre: "Objects" },
  { id: "t9",  label: "Blocks",       emoji: "🧱",  genre: "Objects" },
  { id: "t15", label: "Cards",        emoji: "🃏",  genre: "Objects" },
  { id: "t19", label: "Coin",         emoji: "🪙",  genre: "Objects" },
  { id: "t21", label: "Dice",         emoji: "🎲",  genre: "Objects" },
  { id: "t27", label: "Gems",         emoji: "💎",  genre: "Objects" },
  { id: "t28", label: "Goods",        emoji: "📦",  genre: "Objects" },
  { id: "t30", label: "Hexa Blocks",  emoji: "⬡",   genre: "Objects" },
  { id: "t31", label: "Hole",         emoji: "🕳️", genre: "Objects" },
  { id: "t35", label: "Knit / Yarn",  emoji: "🧶",  genre: "Objects" },
  { id: "t36", label: "Liquid",       emoji: "💧",  genre: "Objects" },
  { id: "t37", label: "Lumber",       emoji: "🪵",  genre: "Objects" },
  { id: "t39", label: "Marbles",      emoji: "🔮",  genre: "Objects" },
  { id: "t40", label: "Mining",       emoji: "⛏️", genre: "Objects" },
  { id: "t41", label: "Money",        emoji: "💰",  genre: "Objects" },
  { id: "t43", label: "Numbers",      emoji: "🔢",  genre: "Objects" },
  { id: "t49", label: "Rope",         emoji: "🪢",  genre: "Objects" },
  { id: "t52", label: "Screws",       emoji: "🔩",  genre: "Objects" },
  { id: "t54", label: "Slime",        emoji: "🟢",  genre: "Objects" },
  { id: "t55", label: "Slinky",       emoji: "🌀",  genre: "Objects" },
  { id: "t58", label: "Tools",        emoji: "🔧",  genre: "Objects" },
  { id: "t59", label: "Toys",         emoji: "🧸",  genre: "Objects" },
];
